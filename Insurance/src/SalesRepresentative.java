...
public class SalesRepresentative extends Employee{
	...
	private	List<Vehicle> vehicleList = new ArrayList<Vehicle>();
		...
		public SalesRepresentative(String name, Date dateOfJoin, Date DOB,
				Dealer dealer) {
		...
		//	this.insurance.setpaymentDetails(customer.getPaymentdetails(this.insurance));
		...
		public void registervehicle(Customer customer, Vehicle vehicle,
			...
			//Registration salesregister= vehicle.getRegdetails();
