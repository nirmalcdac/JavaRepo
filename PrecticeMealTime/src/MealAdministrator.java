public class MealAdministrator {
	public static void main(String[] args) {
		System.out.printf("Please note that no eggs will be served at %s, %02d:%02d.%n", Meal.BREAKFAST,
		...
		System.out.printf("Formal dress is required for %s at %02d:%02d.%n", formalDinner, formalDinner.getHour(),
				formalDinner.getMins());
	}
}