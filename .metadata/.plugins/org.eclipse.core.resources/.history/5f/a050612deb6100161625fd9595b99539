...
public class HopField {
	...
	private static void initializePreviousInput(int[] previousInput,
			int[] input) {
		// TODO Auto-generated method stub
		for(int i=0;i<30;i++)
	...
	private static void sum(int[][] result1, int[][] result2, int[][] result3,
			int[][] result4, int[][] result) {
		// TODO Auto-generated method stub
		for(int i=0;i<30;i++)
			for(int j=0;j<30;j++)
