...
public class Versionspace {
	...
	/*String[] s1={"Alma3","Breakfast","Friday","Cheap"};
	String[] s2={"Demote","Lunch","Friday","expensive"};
	String[] s3={"Alma3","Lunch","Saturday","Cheap"};
	String[] s4={"Sedes","Breakfast","Sunday","Cheap"};*/
